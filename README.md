...
Este projeto foi disponibilizado originalmente como um desafio técnico na trilha .NET da **Contexto da DIO (Digital Innovation One)**. Fui a responsável por dar continuidade ao código base, programando as regras de negócio que faltavam e configurando a integração com o banco de dados na nuvem da Microsoft (Azure).
